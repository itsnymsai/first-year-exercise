/* Based on your knowledge set the records below. Create an algorithm that asks the user enter the registration data of a student and a person and print them on the screen: */
